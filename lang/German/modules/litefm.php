<?php
/*
 * Language definitions for the litefm module (German localization)
 */
...
define('OGP_LANG_send_by_email_info', "Um Dateien senden zu können, muss das Paket 'mutt' auf der Agent-Seite installiert sein");
